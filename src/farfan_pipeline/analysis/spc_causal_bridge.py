...
class SPCCausalBridge:
    ...
    @calibrated_method("farfan_core.analysis.spc_causal_bridge.SPCCausalBridge.build_causal_graph_from_spc")
    ...
    @calibrated_method("farfan_core.analysis.spc_causal_bridge.SPCCausalBridge._compute_causal_weight")
    ...
    @calibrated_method("farfan_core.analysis.spc_causal_bridge.SPCCausalBridge.enhance_graph_with_content")
