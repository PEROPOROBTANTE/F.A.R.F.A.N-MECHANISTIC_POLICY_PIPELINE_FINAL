...
class MicroQuestionScorer:
    ...
    @calibrated_method("farfan_core.analysis.scoring.MicroQuestionScorer.score_type_a")
    ...
    @calibrated_method("farfan_core.analysis.scoring.MicroQuestionScorer.score_type_b")
    ...
    @calibrated_method("farfan_core.analysis.scoring.MicroQuestionScorer.score_type_c")
    ...
    @calibrated_method("farfan_core.analysis.scoring.MicroQuestionScorer.score_type_e")
    ...
    @calibrated_method("farfan_core.analysis.scoring.MicroQuestionScorer.score_type_f")
    ...
    @calibrated_method("farfan_core.analysis.scoring.MicroQuestionScorer.determine_quality_level")
