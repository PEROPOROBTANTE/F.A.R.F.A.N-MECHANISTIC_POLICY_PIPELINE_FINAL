...
class ProvenanceDAG:
    ...
    @calibrated_method("farfan_core.analysis.micro_prompts.ProvenanceDAG.get_root_nodes")
    def get_root_nodes(self) -> list[str]:
        """Get nodes without parents (primary inputs)"""
        return [nid for nid, node in self.nodes.items() if not node.parent_ids]

    @calibrated_method("farfan_core.analysis.micro_prompts.ProvenanceDAG.get_orphan_nodes")
...
class ProvenanceAuditor:
    ...
    @calibrated_method("farfan_core.analysis.micro_prompts.ProvenanceAuditor._check_latency_anomalies")
    ...
    @calibrated_method("farfan_core.analysis.micro_prompts.ProvenanceAuditor._schemas_match")
    ...
    @calibrated_method("farfan_core.analysis.micro_prompts.ProvenanceAuditor.to_json")
...
class BayesianPosteriorExplainer:
    ...
    @calibrated_method("farfan_core.analysis.micro_prompts.BayesianPosteriorExplainer._rank_signals_by_impact")
    ...
    @calibrated_method("farfan_core.analysis.micro_prompts.BayesianPosteriorExplainer._justify_test_type")
    ...
    @calibrated_method("farfan_core.analysis.micro_prompts.BayesianPosteriorExplainer._signal_to_dict")
    ...
    @calibrated_method("farfan_core.analysis.micro_prompts.BayesianPosteriorExplainer.to_json")
...
class CausalChain:
    ...
    @calibrated_method("farfan_core.analysis.micro_prompts.CausalChain.length")
    def length(self) -> int:
...
class AntiMilagroStressTester:
    ...
    @calibrated_method("farfan_core.analysis.micro_prompts.AntiMilagroStressTester._generate_explanation")
    ...
    @calibrated_method("farfan_core.analysis.micro_prompts.AntiMilagroStressTester.to_json")
