...
def _detect_project_root() -> Path:
    ...
    2. Secondary strategy: Search for src/farfan_core layout
       - Looks for directories with both src/farfan_core and setup.py
       - This supports older project structures

    3. Fallback strategy: Relative path calculation
       - If no markers found, assumes standard layout (src/farfan_core/utils)
