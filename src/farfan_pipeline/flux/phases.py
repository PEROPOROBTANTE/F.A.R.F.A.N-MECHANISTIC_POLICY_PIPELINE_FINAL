...
from farfan_pipeline.core.observability.structured_logging import log_fallback
...
# SPC is the ONLY canonical Phase-One entry point (src/farfan_core/processing/spc_ingestion)
