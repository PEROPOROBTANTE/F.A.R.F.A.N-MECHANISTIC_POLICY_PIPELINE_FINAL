...
class IndustrialPolicyProcessor:
    ...
    def _run_contradiction_analysis(
        ...
        domain_weights = {
            ...
            CausalDimension.D3_PRODUCTOS: get_parameter_loader().get("farfan_core.processing.policy_processor.IndustrialPolicyProcessor.process").get("auto_param_L1001_42", 1.0),
