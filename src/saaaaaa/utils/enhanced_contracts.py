...
class ContractValidationError(Exception):
    ...
    def __init__(self, message: str, field: str | None = None, event_id: str | None = None):
        self.field = field
...
class DataIntegrityError(Exception):
    ...
    def __init__(self, message: str, expected: str | None = None, got: str | None = None, event_id: str | None = None):
...
class SystemConfigError(Exception):
    ...
    def __init__(self, message: str, config_key: str | None = None, event_id: str | None = None):
...
class FlowCompatibilityError(Exception):
    ...
    def __init__(self, message: str, producer: str | None = None, consumer: str | None = None, event_id: str | None = None):
