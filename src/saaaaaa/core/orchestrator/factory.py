...
def build_processor(
    *,
    ...
    # TODO: The signal processing logic has been temporarily disabled due to an
    # unresolved issue during the refactoring. The `bayesian_module_factory`
    # is causing a circular import that needs to be investigated and fixed.
    # Re-enable this section once the circular import is resolved.
    #if enable_signals:
    #    try:
